    ...
    {/* <div id="home" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-28"> */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex justify-center mt-8 md:order-1">
          <img
            src={pic}
            className="rounded-full md:w-[450px] md:h-[450px] shadow-lg transform transition-transform duration-500 hover:scale-105 hover:shadow-2xl"
            alt="Profile"
          />
        </div>
            ...
            <div className="space-y-2">
              ...
              <ul className="flex space-x-5 justify-center">
                {[
                  ...
                  // { href: "https://www.youtube.com/", icon: <IoLogoYoutube className="text-2xl" /> },
